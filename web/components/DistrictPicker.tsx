...
const ACCENT = {
  a: { border: "border-blue-200", ring: "focus-within:ring-blue-500", dot: "bg-blue-600" },
  b: { border: "border-fuchsia-200", ring: "focus-within:ring-fuchsia-500", dot: "bg-fuchsia-600" },
} as const;
  ...
  return (
    <div className={`rounded-2xl border bg-white p-4 shadow-sm ${styles.border}`}>
      ...
      <select
        ...
        className={`mt-2 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-900 focus:outline-none focus:ring-2 ${styles.ring}`}
      >
