...
{
    /// <inheritdoc />
    public partial class AddHealthAccessReadings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "HealthAccessReadings",
                columns: table => new
                {
                    NeighborhoodId = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    WeightedHealthIndex = table.Column<double>(type: "double precision", nullable: false),
                    MahalleCount = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthAccessReadings", x => x.NeighborhoodId);
                });
        }
